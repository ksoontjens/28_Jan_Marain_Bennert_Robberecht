...
public class EersteProg{
	...
	public static void main(String args[])
	{
		...
		blabla = new Faktuur(0001,1630);
		
		nico.salarisVerhogen(10);
		bert.salarisVerhogen(10);
		
		jens.salarisVerhogen(10);
		
		bert.setRSZ((float)0.25);
		jens.setRSZ((float)0.40);
		...
		System.out.println(jens.getSalaris());
		System.out.println(michel.getSalaris());
		
		System.out.println(jan.getRSZ());
		System.out.println(jens.getRSZ());
		
		System.out.println(jens.betaal(jens.getSalaris(),jens.voornaam));
		System.out.println(blabla.betaal((float)blabla.faktuurBedrag," " + blabla.faktuurNr));
